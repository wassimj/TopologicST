    ...
    with tab3:
        ...
        with col1:
            ...
            fig = go.Figure(go.Barpolar(r=d["Window Area"],
                                        ...
                                        marker_line_width=1,
                                        opacity=0.8))
            fig.update_layout(title="Window Area", margin=dict(l=10, r=10, t=24, b=2), paper_bgcolor='rgba(1,1,1,1)', polar = dict(
        ...
        with col2:
            ...
            fig = go.Figure(go.Barpolar(r=d["Wall Area"],
                                        ...
                                        marker_line_width=1,
                                        opacity=0.8))
            fig.update_layout(title="Wall Area", margin=dict(l=10, r=10, t=24, b=2), paper_bgcolor='rgba(1,1,1,1)', polar = dict(
            radialaxis = dict(showticklabels=False, ticks='')))
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col3:
            ...
            fig = go.Figure(go.Barpolar(r=d["WWR By Orient"],
                                        ...
                                        marker_line_width=1,
                                        opacity=0.8))
            fig.update_layout(title="WWR By Orientation", margin=dict(l=10, r=10, t=24, b=2), paper_bgcolor='rgba(1,1,1,1)', polar = dict(
            radialaxis = dict(showticklabels=False, ticks='')))
        ...
        with col4:
            ...
            fig = go.Figure(go.Barpolar(r=d["WWR By Project"],
                                        ...
                                        marker_line_width=1,
                                        opacity=0.8))
            fig.update_layout(title="WWR By Project", margin=dict(l=10, r=10, t=24, b=2), paper_bgcolor='rgba(1,1,1,1)', polar = dict(
            radialaxis = dict(showticklabels=False, ticks='')))
            st.plotly_chart(fig, use_container_width=True)
